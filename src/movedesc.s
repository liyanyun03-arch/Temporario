...
.word FIERY_WARTH_description
.word STRANGE_STEAM_description
.word EERIE_SPELL_description
.word COLD_GAG_description
.word ZIPPY_ZAP_description
.word CHLOROBLAST_description
.word INFERNAL_PARADE_description
.word INFERNAL_PARADE_description
.word PSYSHIELD_description
.word CEASELESS_EDGE_description
.word CEASELESS_EDGE_description
.word TRIPLE_ARROWS_description
.word SHELL_SIDE_ARM_description
.word EXPANDING_FORCE_description
.word SHELL_SIDE_ARM_description
.word CLANG_SOUL_description
.word CHLOROBLAST_description
...
.word RAGING_FURY_description
.word DIRE_CLAW_description
.word VICTORY_DANCE_description
.word BITTER_MALICE_description
.word MOVE_SHELTER_description
.word MOUNTAIN_GALE_description
.word NOTHING_description
.word NOTHING_description
.word NOTHING_description
.word NOTHING_description
...
.byte U_, t_, i_, l_, i_, z_, a_, r_,0x17, Space, a_, Space, D_, e_, f_, Space, d_, o_, Space, p_, o_, r_, t_, a_, d_, o_, r_, 0xFE
.byte c_, o_, m_, o_, Space, d_, a_, n_, o_, Space, b_, a_, s_, e_, Space, d_, o_, Space, g_, o_, l_, p_, e_, Dot, 0xFF

SNAP_TRAP_description:
.byte 0xCA, 0xE6, 0xD9, 0xE2, 0xD8, 0xD9, 0x00, 0xE3, 0x00, 0xD5, 0xD8, 0xEA, 0xD9, 0xE6, 0xE7, 0x17, 0xE6, 0xDD, 0xE3, 0x00, 0xD9, 0xE1, 0x00, 0xE9, 0xE1, 0xD5, 0xFE, 0xE8, 0xE6, 0xD5, 0xE4, 0x00, 0xD8, 0xE9, 0xE6, 0xD5, 0xE2, 0xE8, 0xD9, 0x00, 0xA5, 0xAE, 0xA6, 0x00, 0xE8, 0xE9, 0xE6, 0xE2, 0xE3, 0xE7, 0xAD, 0xFF

SHELL_SIDE_ARM_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0xE6, 0x17, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xDA, 0x6F, 0xE7, 0xDD, 0xD7, 0xE3, 0x00, 0xE3, 0xE9, 0xFE, 0xE7, 0xE4, 0xD9, 0xD7, 0xDD, 0xD5, 0xE0, 0xB8, 0x00, 0xE3, 0x00, 0xE5, 0xE9, 0xD9, 0x00, 0xDA, 0xE3, 0xE6, 0x00, 0xE1, 0xD5, 0xDD, 0xE3, 0xE6, 0xAD, 0xFF

FREEZING_GLARE_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xE4, 0xE3, 0xD8, 0xD9, 0xFE, 0xD7, 0xE3, 0xE2, 0xDB, 0xD9, 0xE0, 0xD5, 0xE6, 0x00, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0xAD, 0xFF

THUNDEROUS_KICK_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD5, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0xB8, 0x00, 0xD5, 0xE0, 0x1B, 0xE1, 0xFE, 0xD8, 0xD9, 0x00, 0xE4, 0xE3, 0xD8, 0xD9, 0xE6, 0x00, 0xE6, 0xD9, 0xD8, 0xE9, 0xEE, 0xDD, 0xE6, 0x00, 0xBE, 0xD9, 0xDA, 0x00, 0xD8, 0xD9, 0xE0, 0xD9, 0xAD, 0xFF

FIERY_WARTH_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xE7, 0xDD, 0xE0, 0xD9, 0xE2, 0xD7, 0xDD, 0xD5, 0xFE, 0xD5, 0xE1, 0xD6, 0xE3, 0xE7, 0x00, 0xE3, 0xE7, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0xE7, 0xAD, 0xFF

STRANGE_STEAM_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xE4, 0xE3, 0xD8, 0xD9, 0x00, 0xD8, 0xD9, 0xDD, 0xEC, 0xD5, 0xE6, 0xFE, 0xE3, 0x00, 0xD5, 0xD8, 0xEA, 0xD9, 0xE6, 0xE7, 0x17, 0xE6, 0xDD, 0xE3, 0x00, 0xD7, 0xE3, 0xE2, 0xDA, 0xE9, 0xE7, 0xE3, 0xAD, 0xFF

EERIE_SPELL_description:
.byte 0xCC, 0xD9, 0xD8, 0xE9, 0xEE, 0x00, 0xA4, 0x00, 0xCA, 0xCA, 0xB4, 0xE7, 0x00, 0xD8, 0xE3, 0x00, 0x27, 0xE0, 0xE8, 0xDD, 0xE1, 0xE3, 0xFE, 0xDB, 0xE3, 0xE0, 0xE4, 0xD9, 0x00, 0xE9, 0xE8, 0xDD, 0xE0, 0xDD, 0xEE, 0xD5, 0xD8, 0xE3, 0x00, 0xE4, 0xD9, 0xE0, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0xAD, 0xFF

COLD_GAG_description:
.byte 0xCD, 0xD9, 0x00, 0xE6, 0xD9, 0xE8, 0xDD, 0xE6, 0xD5, 0x00, 0xD8, 0xE3, 0x00, 0xD7, 0xD5, 0xE1, 0xE4, 0xE3, 0xB8, 0x00, 0xD7, 0xDC, 0xD5, 0xE1, 0xD5, 0xFE, 0xE9, 0xE1, 0x00, 0xD5, 0xE0, 0xDD, 0xD5, 0xD8, 0xE3, 0x00, 0xD9, 0x00, 0xD7, 0xE3, 0xE2, 0xEA, 0xE3, 0xD7, 0xD5, 0x00, 0xC2, 0xD5, 0xDD, 0xE0, 0xAD, 0xFF

ZIPPY_ZAP_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xE5, 0xE9, 0xD9, 0x00, 0xE7, 0xD9, 0xE1, 0xE4, 0xE6, 0xD9, 0xFE, 0xE6, 0xD9, 0xE7, 0xE9, 0xE0, 0xE8, 0xD5, 0xE6, 0x17, 0x00, 0xD9, 0xE1, 0x00, 0xDC, 0xDD, 0xE8, 0x00, 0xD7, 0xE6, 0x6F, 0xE8, 0xDD, 0xD7, 0xE3, 0xAD, 0xFF

CHLOROBLAST_description:
.byte 0xCC, 0xD9, 0xD7, 0xD9, 0xD6, 0xD9, 0x00, 0xA6, 0xA1, 0x5B, 0x00, 0xD8, 0xE3, 0x00, 0xC2, 0xCA, 0x00, 0xE1, 0x17, 0xEC, 0xDD, 0xE1, 0xE3, 0xFE, 0xD7, 0xE3, 0xE1, 0xE3, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD8, 0xD9, 0x00, 0xCC, 0xD9, 0xD7, 0xE3, 0xDD, 0xE0, 0xAD, 0xFF

INFERNAL_PARADE_description:
.byte 0xBE, 0xE3, 0xD6, 0xE6, 0xD5, 0x00, 0xE7, 0xD9, 0xE9, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xE7, 0xD9, 0x00, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0xFE, 0xE8, 0xDD, 0xEA, 0xD9, 0xE6, 0x00, 0xE4, 0xE6, 0xE3, 0xD6, 0xE0, 0xD9, 0xE1, 0xD5, 0x00, 0xD8, 0xD9, 0x00, 0xE7, 0xE8, 0xD5, 0xE8, 0xE9, 0xE7, 0xAD, 0xFF

PSYSHIELD_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD5, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0x00, 0xD9, 0x00, 0xD8, 0xD9, 0xE4, 0xE3, 0xDD, 0xE7, 0xFE, 0xD9, 0xE0, 0xD9, 0xEA, 0xD5, 0x00, 0xD5, 0x00, 0xBE, 0xD9, 0xDA, 0xD9, 0xE2, 0xE7, 0xD9, 0x00, 0xD8, 0xE3, 0x00, 0xE4, 0xE3, 0xE6, 0xE8, 0xD5, 0xD8, 0xE3, 0xE6, 0xAD, 0xFF

CEASELESS_EDGE_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD5, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0x00, 0xD9, 0xFE, 0xE4, 0xE3, 0xE7, 0xE7, 0xE9, 0xDD, 0x00, 0xD5, 0xE0, 0xE8, 0xD5, 0x00, 0x5B, 0x00, 0xD7, 0xE6, 0xDD, 0xE8, 0xDD, 0xD7, 0xD5, 0xAD, 0xFF

TRIPLE_ARROWS_description:
.byte 0xCA, 0xE3, 0xD8, 0xD9, 0xE6, 0x17, 0x00, 0xE6, 0xD9, 0xD8, 0xE9, 0xEE, 0xDD, 0xE6, 0x00, 0xD5, 0x00, 0xBE, 0xD9, 0xDA, 0xFE, 0xD9, 0xBA, 0xE3, 0xE9, 0x00, 0xE7, 0xDD, 0xE0, 0xD9, 0xE2, 0xD7, 0xDD, 0xD5, 0xE6, 0x00, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0xAD, 0xFF

EXPANDING_FORCE_description:
.byte 0xBF, 0xE0, 0xD9, 0xEA, 0xD5, 0x00, 0xE3, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xE7, 0xD9, 0x00, 0xE3, 0x00, 0xCA, 0xE7, 0xED, 0xFE, 0xCE, 0xD9, 0xE6, 0xE6, 0xD5, 0xDD, 0xE2, 0x00, 0xD9, 0xE7, 0xE8, 0xDD, 0xEA, 0xD9, 0xE6, 0x00, 0xD5, 0xE8, 0xDD, 0xEA, 0xE3, 0xAD, 0xFF

CLANG_SOUL_description:
.byte 0xBF, 0xE0, 0xD9, 0xEA, 0xD5, 0x00, 0xE8, 0xE3, 0xD8, 0xE3, 0xE7, 0x00, 0xE7, 0xD9, 0xE9, 0xE7, 0x00, 0xE7, 0xE8, 0xD5, 0xE8, 0xE7, 0xFE, 0xD5, 0xE3, 0x00, 0xD7, 0xE9, 0xE7, 0xE8, 0xE3, 0x00, 0xD8, 0xD9, 0x00, 0xA2, 0xBA, 0xA4, 0x00, 0xD8, 0xE3, 0x00, 0xC2, 0xCA, 0xAD, 0xFF

PLASMA_FISTS_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xD5, 0xE0, 0xE8, 0xD9, 0xE6, 0xD5, 0x00, 0xDB, 0xE3, 0xE0, 0xE4, 0xD9, 0xE7, 0xFE, 0xC8, 0xE3, 0xE6, 0xE1, 0xD5, 0xE0, 0x00, 0xE4, 0xD5, 0xE6, 0xD5, 0x00, 0xBF, 0xE0, 0xD9, 0xD7, 0xE8, 0xE6, 0xDD, 0xD7, 0xAD, 0xFF

DOUBLE_IRON_BASH_description:
.byte 0xBB, 0xE8, 0xD5, 0xD7, 0xD5, 0x00, 0xA3, 0x00, 0xEA, 0xD9, 0xEE, 0xD9, 0xE7, 0xB8, 0x00, 0xE4, 0xE3, 0xD8, 0xD9, 0xE2, 0xD8, 0xE3, 0xFE, 0xE7, 0xDD, 0xE0, 0xD9, 0xE2, 0xD7, 0xDD, 0xD5, 0xE6, 0x00, 0xE3, 0x00, 0xD5, 0xD8, 0xEA, 0xD9, 0xE6, 0xE7, 0x17, 0xE6, 0xDD, 0xE3, 0xAD, 0xFF

THUNDER_CAGE_description:
.byte 0xCA, 0xE6, 0xD9, 0xE2, 0xD8, 0xD9, 0x00, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0x00, 0xD9, 0xE1, 0x00, 0xE9, 0xE1, 0xD5, 0x00, 0xDB, 0xD5, 0xDD, 0xE3, 0xE0, 0xD5, 0xFE, 0xD9, 0xE0, 0xD9, 0xE8, 0xE6, 0x6F, 0xD7, 0xD5, 0x00, 0xD8, 0xE9, 0xE6, 0xD5, 0xE2, 0xE8, 0xD9, 0x00, 0xA5, 0xAE, 0xA6, 0x00, 0xE8, 0xE9, 0xE6, 0xE2, 0xE3, 0xE7, 0xAD, 0xFF

DRAGON_ENERGY_description:
.byte 0xBD, 0xE3, 0xE2, 0xEA, 0xD9, 0xE6, 0xE8, 0xD9, 0x00, 0xC2, 0xCA, 0x00, 0xD9, 0xE1, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0xAD, 0x00, 0xCB, 0xE9, 0xD5, 0xE2, 0xE8, 0xE3, 0xFE, 0xE1, 0xD9, 0xE2, 0xE3, 0xE6, 0x00, 0xE7, 0xD9, 0xE9, 0x00, 0xC2, 0xCA, 0xB8, 0x00, 0xE1, 0xD9, 0xE2, 0xE3, 0xE6, 0x00, 0xE3, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0xAD, 0xFF

COACHING_description:
.byte 0xBF, 0xE0, 0xD9, 0xEA, 0xD5, 0x00, 0xBB, 0xE8, 0xDF, 0x00, 0xD9, 0x00, 0xBE, 0xD9, 0xDA, 0x00, 0xD8, 0xD9, 0x00, 0xD5, 0xE0, 0xDD, 0xD5, 0xD8, 0xE3, 0xE7, 0xB8, 0xFE, 0xDD, 0xDB, 0xE2, 0xE3, 0xE6, 0xD5, 0xE2, 0xD8, 0xE3, 0x00, 0xE8, 0xE9, 0xD8, 0xE3, 0x00, 0xD9, 0x00, 0xE8, 0xE3, 0xD8, 0xE3, 0xE7, 0xAD, 0xFF

MISTY_EXPLOSION_description:
.byte 0xBF, 0xE0, 0xD9, 0xEA, 0xD5, 0x00, 0xE3, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD8, 0xE3, 0x00, 0xDB, 0xE3, 0xE0, 0xE4, 0xD9, 0x00, 0xE7, 0xD9, 0xFE, 0xE3, 0x00, 0xC7, 0xDD, 0xE7, 0xE8, 0xED, 0x00, 0xC0, 0xDD, 0xD9, 0xE0, 0xD8, 0x00, 0xD9, 0xE7, 0xE8, 0xDD, 0xEA, 0xD9, 0xE6, 0x00, 0xD5, 0xE8, 0xDD, 0xEA, 0xE3, 0xAD, 0xFF

METEOR_ASSAULT_description:
.byte 0xFC, 0x06, 0x00, 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xDA, 0xE3, 0xE6, 0x19, 0xD5, 0x00, 0xE3, 0x00, 0xE4, 0xE3, 0xE6, 0xE8, 0xD5, 0xD8, 0xE3, 0xE6, 0xFE, 0xD5, 0x00, 0xE6, 0xD9, 0xD7, 0xD5, 0xE6, 0xE6, 0xD9, 0xDB, 0xD5, 0xE6, 0x00, 0xE2, 0xE3, 0x00, 0xE4, 0xE6, 0x23, 0xEC, 0xDD, 0xE1, 0xE3, 0x00, 0xE8, 0xE9, 0xE6, 0xE2, 0xE3, 0xAD, 0xFF

OBSTRUCT_description:
.byte 0xBC, 0xE0, 0xE3, 0xE5, 0xE9, 0xD9, 0xDD, 0xD5, 0x00, 0xD5, 0xE8, 0xD5, 0xE5, 0xE9, 0xD9, 0xE7, 0x00, 0xD9, 0x00, 0xE6, 0xD9, 0xD8, 0xE9, 0xEE, 0x00, 0xD5, 0xFE, 0xBE, 0xD9, 0xDA, 0x00, 0xD8, 0xD9, 0x00, 0xE5, 0xE9, 0xD9, 0xE1, 0x00, 0xDA, 0xDD, 0xEE, 0xD9, 0xE6, 0x00, 0xD7, 0xE3, 0xE2, 0xE8, 0xD5, 0xE8, 0xE3, 0xAD, 0xFF

RAGING_FURY_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD8, 0xE9, 0xE6, 0xD5, 0xE2, 0xE8, 0xD9, 0x00, 0xA3, 0xAE, 0xA4, 0xFE, 0xE8, 0xE9, 0xE6, 0xE2, 0xE3, 0xE7, 0xB8, 0x00, 0xD8, 0xD9, 0xE4, 0xE3, 0xDD, 0xE7, 0x00, 0xDA, 0xDD, 0xD7, 0xD5, 0x00, 0xD7, 0xE3, 0xE2, 0xDA, 0xE9, 0xE7, 0xE3, 0xAD, 0xFF

DIRE_CLAW_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xE4, 0xE3, 0xD8, 0xD9, 0x00, 0xD5, 0xE4, 0xE0, 0xDD, 0xD7, 0xD5, 0xE6, 0xFE, 0xCA, 0xE3, 0xDD, 0xE7, 0xE3, 0xE2, 0xB8, 0x00, 0xCD, 0xE0, 0xD9, 0xD9, 0xE4, 0x00, 0xE3, 0xE9, 0x00, 0xCA, 0xD5, 0xE6, 0xD5, 0xE0, 0xED, 0xEE, 0xD9, 0xAD, 0xFF

VICTORY_DANCE_description:
.byte 0xBF, 0xE0, 0xD9, 0xEA, 0xD5, 0x00, 0xE3, 0x00, 0xBB, 0xE8, 0xDF, 0xB8, 0x00, 0xBE, 0xD9, 0xDA, 0x00, 0xD9, 0x00, 0xD5, 0xFE, 0xCD, 0xE4, 0xD9, 0xD9, 0xD8, 0x00, 0xD8, 0xE3, 0x00, 0xE4, 0xE3, 0xE6, 0xE8, 0xD5, 0xD8, 0xE3, 0xE6, 0xAD, 0xFF

BITTER_MALICE_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xD5, 0xDD, 0xE2, 0xD8, 0xD5, 0x00, 0xE6, 0xD9, 0xD8, 0xE9, 0xEE, 0xFE, 0xE3, 0x00, 0xBB, 0xE8, 0xDF, 0x00, 0xD8, 0xE3, 0x00, 0xD5, 0xD8, 0xEA, 0xD9, 0xE6, 0xE7, 0x17, 0xE6, 0xDD, 0xE3, 0xAD, 0xFF

MOVE_SHELTER_description:
.byte 0xBF, 0xE0, 0xD9, 0xEA, 0xD5, 0x00, 0xD5, 0x00, 0xBF, 0xEA, 0xD5, 0xE7, 0xDD, 0xEA, 0xD5, 0x00, 0xD9, 0xFE, 0xD5, 0x00, 0xBE, 0xD9, 0xDA, 0x00, 0xD8, 0xE3, 0x00, 0xE4, 0xE3, 0xE6, 0xE8, 0xD5, 0xD8, 0xE3, 0xE6, 0xAD, 0xFF

MOUNTAIN_GALE_description:
.byte 0xBD, 0xD5, 0xE9, 0xE7, 0xD5, 0x00, 0xD8, 0xD5, 0xE2, 0xE3, 0x00, 0xD9, 0x00, 0xE4, 0xE3, 0xD8, 0xD9, 0xFE, 0xE7, 0xDD, 0xE0, 0xD9, 0xE2, 0xD7, 0xDD, 0xD5, 0xE6, 0x00, 0xE3, 0x00, 0xD5, 0xE0, 0xEA, 0xE3, 0xAD, 0xFF

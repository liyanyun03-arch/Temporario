...
const u16 sound_moves[] = {MOVE_BOOMBURST, MOVE_BUG_BUZZ, MOVE_CHATTER, MOVE_CLANGING_SCALES, MOVE_CONFIDE,
        ...
        MOVE_SING, MOVE_SNARL, MOVE_SNORE, MOVE_SPARKLING_ARIA, MOVE_SUPERSONIC, MOVE_UPROAR, MOVE_EERIE_SPELL, 0xFFFF};
const u16 sound_moves2[] = {MOVE_GRASS_WHISTLE,MOVE_SING, 0xFFFF};
const u16 trap_moves[] = {MOVE_ANCHOR_SHOT, MOVE_BLOCK, MOVE_FAIRY_LOCK, MOVE_THOUSAND_WAVES, MOVE_MEAN_LOOK, MOVE_SPIDER_WEB, MOVE_SPIRIT_SHACKLE, 0xFFFF};
const u16 weather_moves[] = {MOVE_CHILLY_RECEPTION, MOVE_RAIN_DANCE, MOVE_SANDSTORM, MOVE_SUNNY_DAY, 0xFFFF};
...
const u16 harzad_moves[] = {MOVE_SPIKES, MOVE_TOXIC_SPIKES, MOVE_STEALTH_ROCK, MOVE_STICKY_WEB, 0xFFFF};
...
const u16 reckless_moves_table[] = {MOVE_BRAVE_BIRD, MOVE_DOUBLEEDGE, MOVE_FLARE_BLITZ, MOVE_HEAD_CHARGE,
        ...
        MOVE_VOLT_TACKLE, MOVE_WOOD_HAMMER, MOVE_WILD_CHARGE, MOVE_MIND_BLOWN, MOVE_STRUGGLE, 0xFFFF};
...
const u16 sheerforce_moves_table[] = {MOVE_WATERFALL, MOVE_IRON_HEAD, MOVE_STOMP, MOVE_ZEN_HEADBUTT, MOVE_ROCK_CLIMB,
        ...
        MOVE_DOUBLE_IRON_BASH, MOVE_STRANGE_STEAM, MOVE_SHELL_SIDE_ARM, MOVE_SHELL_SIDE_ARM_PHYSICAL, MOVE_FREEZING_GLARE,
		MOVE_FIERY_WRATH, MOVE_THUNDEROUS_KICK, MOVE_EERIE_SPELL, 0xFFFF};
...
const u16 always_crit_hits[] = {MOVE_FROST_BREATH, MOVE_STORM_THROW, MOVE_ZIPPY_ZAP, 0xFFFF};
...
const u16 pressing_moves_table[] = {MOVE_BODY_SLAM, MOVE_DRAGON_RUSH, MOVE_FLYING_PRESS, MOVE_HEAT_CRASH, MOVE_STEAMROLLER,
		MOVE_STOMP, MOVE_HEAVY_SLAM, MOVE_SHADOW_FORCE, MOVE_PHANTOM_FORCE, 0xFFFF};
const u16 sharpness_moves_table[] = {MOVE_AERIAL_ACE, MOVE_AIR_CUTTER, MOVE_AIR_SLASH, MOVE_CEASELESS_EDGE, MOVE_FURY_CUTTER,
		MOVE_LEAF_BLADE, MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_RAZOR_SHELL, MOVE_SACRED_SWORD, MOVE_SECRET_SWORD, MOVE_SLASH,
		MOVE_XSCISSOR, MOVE_CROSS_POISON, MOVE_CUT, MOVE_RAZOR_LEAF, MOVE_SOLAR_BLADE, 0xFFFF};
const u16 copy_moves[] = {MOVE_MIMIC, MOVE_TRANSFORM, MOVE_ROLE_PLAY, MOVE_SKETCH, MOVE_ME_FIRST, 0xFFFF};
const u16 priority_moves[] = {MOVE_HELPING_HAND, MOVE_BANEFUL_BUNKER, MOVE_DETECT, MOVE_ENDURE, MOVE_KINGS_SHIELD, 
							  MOVE_MAGIC_COAT, MOVE_PROTECT, MOVE_SPIKY_SHIELD, MOVE_SNATCH, MOVE_CRAFTY_SHIELD, 
							  MOVE_FAKE_OUT, MOVE_QUICK_GUARD, MOVE_WIDE_GUARD, MOVE_SPOTLIGHT, MOVE_ALLY_SWITCH, 
							  MOVE_EXTREME_SPEED, MOVE_FEINT, MOVE_FIRST_IMPRESSION, MOVE_FOLLOW_ME, MOVE_RAGE_POWDER, 
							  MOVE_ACCELEROCK, MOVE_AQUA_JET, MOVE_BABYDOLL_EYES, MOVE_BIDE, MOVE_BULLET_PUNCH, 
							  MOVE_ICE_SHARD, MOVE_ION_DELUGE, MOVE_MACH_PUNCH, MOVE_POWDER, MOVE_QUICK_ATTACK, 
							  MOVE_SHADOW_SNEAK, MOVE_SUCKER_PUNCH, MOVE_VACUUM_WAVE, MOVE_WATER_SHURIKEN, 0xFFFF};
const u16 crit_moves_tai[] = {MOVE_AEROBLAST, MOVE_AIR_CUTTER, MOVE_ATTACK_ORDER, MOVE_BLAZE_KICK, 
						  MOVE_CROSS_CHOP, MOVE_CROSS_POISON, MOVE_DRILL_RUN, MOVE_ESPER_WING, 
						  MOVE_FROST_BREATH, MOVE_KARATE_CHOP, MOVE_LEAF_BLADE, MOVE_NIGHT_SLASH, 
						  MOVE_POISON_TAIL, MOVE_PSYCHO_CUT, MOVE_RAZOR_LEAF, MOVE_RAZOR_WIND, 
						  MOVE_SHADOW_CLAW, MOVE_SKY_ATTACK, MOVE_SLASH, MOVE_SPACIAL_REND, 
						  MOVE_STONE_EDGE, MOVE_STORM_THROW, MOVE_TRIPLE_ARROW, MOVE_ZIPPY_ZAP, 0xFFFF};
const u16 istwoturnnotsemiinvulnerablemove[] = {MOVE_SOLAR_BLADE, MOVE_GEOMANCY, MOVE_ICE_BURN, MOVE_FREEZE_SHOCK, MOVE_SKY_ATTACK,
												MOVE_SKULL_BASH, MOVE_DIG, MOVE_SOLAR_BEAM, MOVE_RAZOR_WIND, 0xFFFF};
const u16 ignore_effectiveness_moves[] = {MOVE_SONIC_BOOM, MOVE_DRAGON_RAGE, MOVE_NIGHT_SHADE, MOVE_SEISMIC_TOSS, MOVE_PSYWAVE,
												MOVE_SHEER_COLD, MOVE_GUILLOTINE, MOVE_HORN_DRILL, MOVE_FISSURE, MOVE_BIDE, 
												MOVE_SUPER_FANG, MOVE_NATURES_MADNESS, MOVE_ENDEAVOR, MOVE_COUNTER,
												MOVE_MIRROR_COAT, MOVE_METAL_BURST, MOVE_FINAL_GAMBIT, 0xFFFF};
const u16 ignore_substitute[] = {MOVE_WHIRLWIND, MOVE_METAL_SOUND, MOVE_GRASS_WHISTLE, MOVE_MIRACLE_EYE, MOVE_ME_FIRST, MOVE_POWER_SWAP, MOVE_GUARD_SWAP, MOVE_HEART_SWAP,
								MOVE_AFTER_YOU, MOVE_REFLECT_TYPE, MOVE_BESTOW, MOVE_FAIRY_LOCK, MOVE_PLAY_NICE, MOVE_HYPERSPACE_HOLE, MOVE_AROMATIC_MIST, 
								MOVE_MAGNETIC_FLUX, MOVE_HOLD_HANDS, MOVE_HYPERSPACE_FURY, MOVE_GEAR_UP, MOVE_SPEED_SWAP, MOVE_INSTRUCT, MOVE_SPECTRAL_THIEF, 0xFFFF}; 
const u16 status_effect_scripts[] = {MOVE_SING, MOVE_SLEEP_POWDER, MOVE_HYPNOSIS, MOVE_LOVELY_KISS, MOVE_SPORE, MOVE_GRASS_WHISTLE, MOVE_DARK_VOID,
									 MOVE_POISON_POWDER, MOVE_POISON_GAS, MOVE_TOXIC, MOVE_GLARE, MOVE_STUN_SPORE, MOVE_THUNDER_WAVE,
									 MOVE_WILLOWISP, MOVE_YAWN, 0xFFFF};
const u16 sleep_moves[] = {MOVE_DARK_VOID, MOVE_GRASS_WHISTLE, MOVE_HYPNOSIS, MOVE_LOVELY_KISS, MOVE_PSYCHO_SHIFT, MOVE_RELIC_SONG, MOVE_REST, MOVE_SECRET_POWER,
						   MOVE_SING, MOVE_SLEEP_POWDER, MOVE_SPORE, MOVE_YAWN, 0xFFFF};
...
const u16 terrainstrings[] = {0x1FB, 0x1FC, 0x1FD, 0x233, 0x269};
...
const u16 terrainend_strings[] = {0x1C3, 0x1C4, 0x1C5, 0x26a}; //grassy, misty, electric, psychic
...
const u16 bind_strings[] = {0x5A, 0x5B, 0x5C, 0x5D, 0x148, 0x17C, 0x17D, 0x184, 0x260, 0x261}; //bind, whirlpool, wrap, clamp, sand tomb, fire spin, magma storm, infestation, snap trap e thunder cage
const u16 barrier_strings[] ={0x26b, 0x26c, 0x26d, 0x26e, 0x26f};
const u16 recoil_strings[] ={0x25B, 0x23B};
#include "config.h"

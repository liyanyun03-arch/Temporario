...
for candidatePath in Paths:
    if "devkitARM" in candidatePath:
        ...
        break
if PATH == "":
	print('DevKit não existe no local das variáveis.\nVerificando local padrão.')
	PATH = 'C://devkitPro//devkitARM//bin'
	if os.path.isdir(PATH) == False:
		print("...\nDevkit não encontrado.")
		sys.exit(1)
	else:
		print("Devkit encontrado.")
